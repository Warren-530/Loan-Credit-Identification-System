        ...
        <div className="relative border-l pl-4 border-slate-200">
          ...
          {showAccountMenu && (
            <>
              ...
              />
              <Card className="absolute right-0 top-14 w-72 z-20 shadow-xl border-slate-200">
                <div className="p-4">
                  <div className="flex items-center gap-3 mb-4 pb-4 border-b border-slate-200">
                    <div className="h-12 w-12 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700 font-bold text-lg border-2 border-emerald-200">
                      {getInitials(user?.displayName || null)}
                    </div>
